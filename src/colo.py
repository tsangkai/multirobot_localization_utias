...
if __name__ == '__main__':
    ...
    #dataset_paths = ["../data/tro/dataset" + str(nds) + "/" for nds in range(1,2)]
    dataset_paths = ["../data/colo/official_dataset" + str(nds) + "/" for nds in range(1,2)]
    robot_labels = [1, 2, 3]
    robots_cant_observe_lm = []
    duration = 180
    ...
    for nds, ds in enumerate(dataset_paths):
        ...
        analyzer.algos_comparison(sr_all, graph_name="COLO_d" + str(nds+1))
